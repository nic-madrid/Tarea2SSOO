...
// Funci�n que convierte una parte de la imagen a escala de grises
...
int main()
{
    // Carpeta que contiene las im�genes de entrada
    ...
    // Pedir al usuario el n�mero de hilos a utilizar
    int numThreads;
    ...
    // Calcular la duraci�n en milisegundos
